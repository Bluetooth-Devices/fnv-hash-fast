...
FNV Hash Fast could always use more documentation, whether as part of the official FNV Hash Fast docs, in docstrings, or even on the web in blog posts, articles, and such.
...
2. Clone your fork locally:
   ...
   ```shell
   $ git clone git@github.com:your_name_here/fnv-hash-fast.git
   ```
